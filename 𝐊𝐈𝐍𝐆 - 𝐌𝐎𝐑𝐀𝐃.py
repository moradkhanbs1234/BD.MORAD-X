...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MORAD-X/Test/blob/main/T.txt').text
		ua=open('.bbnew.txt','w')
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MORAD-X/Test/blob/main/T.txt').text
  ...
  print("""\033[1;32m
         ...
         \033[1;32m 888       888  "Y88888P"  888   T88b d88P     888 8888888P"  
 \033[1;32m=================================================
\033[1;32m[+] AUTHOR    :\033[1;32m  - 
\033[1;32m[+] GITHUB    :\033[1;32m  - 
\033[1;32m[+] YOUTUBE   :\033[1;32m MORAD KHAN BS
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MORAD-X/Test/blob/main/T.txt").text
    if id in httpCaht:
